...
namespace BukkitUI {
    public partial class Form1 : Form {
        ...
        public Form1() {
            ...
            checkedListBox1.SetItemChecked(0, Properties.Settings.Default.checkForUpdatesOnStartup);
            checkedListBox1.SetItemChecked(1, Properties.Settings.Default.checkForUpdatesOnShutdown);
            checkedListBox1.SetItemChecked(2, Properties.Settings.Default.checkForUpdatesDuringRuntime);
        ...
        private void savePrefs_Click(object sender, EventArgs evt) {
            ...
            Properties.Settings.Default.checkForUpdatesOnStartup = checkedListBox1.GetItemChecked(0);
            Properties.Settings.Default.checkForUpdatesOnShutdown = checkedListBox1.GetItemChecked(1);
            Properties.Settings.Default.checkForUpdatesDuringRuntime = checkedListBox1.GetItemChecked(2);
        ...
        private void checkForUpdates_CheckedChanged(object sender, EventArgs evt) {
        ...
        private void getBannedPlayers() {
            ...
            new Thread(() => {
                ...
                while (runManagement) {
                    Invoke((MethodInvoker)delegate {
                        String[] bannedPlayers = File.ReadAllText(Path.Combine(Properties.Settings.Default.bukkitDir, "banned-players.txt")).Split('\n');
